...
function load_vocab(callback) {
    var vocab = {};
    fs.readFile('C:/Users/SHISHUPAL/Desktop/AlgoSearch-main/Helper/TF-IDF-implimentation-main/vocab.txt', 'utf8', (err, vocab_terms) => {
        if (err) throw err;
        fs.readFile('C:/Users/SHISHUPAL/Desktop/AlgoSearch-main/Helper/TF-IDF-implimentation-main/idf-values.txt', 'utf8', (err, idf_values) => {
            if (err) throw err;
...
function load_document(callback) {
    fs.readFile('C:/Users/SHISHUPAL/Desktop/AlgoSearch-main/Helper/TF-IDF-implimentation-main/document.txt', 'utf8', (err, documents) => {
        if (err) throw err;
...
function load_inverted_index(callback) {
    var inverted_index = {};
    fs.readFile('C:/Users/SHISHUPAL/Desktop/AlgoSearch-main/Helper/TF-IDF-implimentation-main/inverted_index.txt', 'utf8', (err, inverted_index_terms) => {
        if (err) throw err;
...
function load_link_of_index(callback) {
    fs.readFile('C:/Users/SHISHUPAL/Desktop/AlgoSearch-main/Helper/TF-IDF-implimentation-main/Leetcode-Scraping/qData/index.txt', 'utf8', (err, links) => {
        if (err) throw err;
...
function load_link_of_qs(callback) {
    fs.readFile('C:/Users/SHISHUPAL/Desktop/AlgoSearch-main/Helper/TF-IDF-implimentation-main/Leetcode-Scraping/qData/Qlink.txt', 'utf8', (err, links) => {
        if (err) throw err;
...
function load_link_of_diff(callback) {
    fs.readFile('C:/Users/SHISHUPAL/Desktop/AlgoSearch-main/Helper/TF-IDF-implimentation-main/Leetcode-Scraping/qData/output.txt', 'utf8', (err, links) => {
        if (err) throw err;
