...
qData_folder = "C:/Users/SHISHUPAL/Desktop/AlgoSearch-main/Helper/TF-IDF-implimentation-main/Leetcode-Scraping/qData"
...
with open("C:/Users/SHISHUPAL/Desktop/AlgoSearch-main/Helper/TF-IDF-implimentation-main/vocab.txt", "w", encoding = 'utf-8', errors = "ignore") as f:
    for key in vocab.keys():
        f.write("%s\n" % key)

# save idf values
with open("C:/Users/SHISHUPAL/Desktop/AlgoSearch-main/Helper/TF-IDF-implimentation-main/idf-values.txt", "w", encoding = 'utf-8', errors = "ignore") as f:
    for key in vocab.keys():
        f.write("%s\n" % vocab[key])


#save the documents(lists of words for each doc)
with open("C:/Users/SHISHUPAL/Desktop/AlgoSearch-main/Helper/TF-IDF-implimentation-main/document.txt", "w", encoding = 'utf-8', errors = "ignore") as f:
...
with open("C:/Users/SHISHUPAL/Desktop/AlgoSearch-main/Helper/TF-IDF-implimentation-main/inverted_index.txt", 'w', encoding = 'utf-8', errors = "ignore") as f:
